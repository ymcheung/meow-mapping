---
title: 'Neko no Hosomichi 猫の細道, Onomichi – Walking from the Train Station'
...
place:
  title: 'Neko no Hosomichi 猫の細道, Onomichi'
hasCover: true
cover:
...
transportation:
  duration: 15
  from:
    place: 'Onomichi Station, Hiroshima, Japan'
    kanji: '広島県尾道駅'
  by: ['walk']
...
![A Calico Cat was Greeting Us.](@assets/onomichi-nekonohosomichi/welcome.jpg)
...
![A Cat at Mt. Senkoji Rope Way Station.](@assets/onomichi-nekonohosomichi/station.jpg)
